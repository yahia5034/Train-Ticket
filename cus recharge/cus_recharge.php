...
<body style="background-image: linear-gradient(120deg,#483014, #a97438); height:1000px;">
    ...
    if (isset($_POST['confirm'])) {
        ...
        $sql = "UPDATE customer SET balance = balance + '$balance' WHERE credit_num = '$credit_num';";
        mysqli_query($conn, $sql);
        $select = "SELECT * FROM customer WHERE credit_num = '$credit_num';";
                    ...
                    <div class="col-md-6" style="padding-top: 138px;padding-right: 16px;padding-left: 164px;height: 350.234px;background: linear-gradient(#734c21 34%, #bfa25e), #734c21;">
                        <div class="card" style="margin-left: -122px;margin-right: 21px;border-color: #734c21;margin-bottom: 209px;">
                            <div class="card-body" style="position: relative;bottom: 70px;border-radius: 10px;margin-left: 0px;border-color: var(--bs-green);background: linear-gradient(#7b4a18, #281704), #734c21;margin-bottom: -88px;padding-bottom: 14px;height: 233.79700000000003px;">
                                <h4 class="card-title" style="text-align: center;color: rgb(45,25,13);">Recharge Customer Balance</h4>
                                <form method="POST" action="" class="search-form">
                                    ...
                                    <div class="input-group" style="border-left-color: var(--bs-gray);"><input class="form-control" type="number" id="numOfSeatsEditTrain-1" placeholder="Amount" name="balance" style="background: #eae7e3;color: #734c21;margin-top: 8px;"></div><input type="submit" name="confirm" value="Confirm" style="position: relative;top: 25px;background: linear-gradient(#ab702e 17%, #bfa25e), #734c21;text-decoration: none;color: #2d190d;padding: 8px;margin-left: 220px;margin-bottom: 126px;margin-top: 39px;padding-left: 16px;padding-right: 16px;border-radius: 5px;">
                                </form>
                            </div>
                        </div>
                    </div>
