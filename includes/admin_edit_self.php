            ...
            <ul class="navbar-nav ms-auto">
                ...
                if (isset($_SESSION['adminid']) || isset($_SESSION['userid'])) {
                    ...
                    if (isset($_SESSION['adminid'])) {
                        ...
                        <a class="dropdown-item" href="admin_edit_cus.php" style="color: #fff !important;background: #212020 !important;">Edit Customer</a>
                        <a class="dropdown-item" href="admin_del_cus.php" style="color: #fff !important;background: #212020 !important;">Delete Customer</a></div>
                        </div>
                        ...
                        <li class="nav-item">
                        <a class="nav-link" style="color: #2d190d;font-weight: bold;" href="admin_edit_self.php">&nbsp;Portfolio</a></li>';
                    }
                    echo '
                        <li class="nav-item">
                        <a class="nav-link" style="color: #2d190d;font-weight: bold;" href="../search.php">&nbsp;Book</a></li>
                        
                        <li class="nav-item">
                        <a class="nav-link" style="color: #2d190d;font-weight: bold;" href="logout.inc.php"><i class="fa fa-sign-out"></i>&nbsp;Log out</a></li>
                        ';
                } else {
                    echo '
                            <li class="nav-item">
...
$cus_id = $_SESSION['adminid'];
$sql = "SELECT * from admin WHERE admin.admin_id=$cus_id;";
...
<body style="margin-left: 0px;background: linear-gradient(180deg, black, #c78e6b), rgb(129,80,51);">
        ...
        <form action="editadmindb.php" method="POST">
            ...
            <div class="row profile-row">
                ...
                <div class="col-md-8" style="background: #dccab4;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group mb-3"><label class="form-label" style="color: rgb(83,50,31);">Username</label><input class="form-control" type="text" name="user_name" value="<?php echo $username; ?> " autocomplete="off" required="" style="border-color: rgb(83,50,31);background: linear-gradient(black, #c78e6b), rgb(129,80,51);"></div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                    ...
                    <div class="row">
                        <div class="col" style="padding-bottom: 15px;">
                            <div><label class="form-label" style="color: rgb(83,50,31);">ID</label><input class="form-control" type="text" name="cus_id" value="<?php echo $id; ?> " style="border-color: rgb(83,50,31);background: linear-gradient(black, #c78e6b), rgb(129,80,51);"></div>
                        </div>
                        <div class="col">
    ...
    <div class="rec">
        ...
        <div class="recharge" style="margin-bottom: 15px;">
            <a class="btn btn-primary" href="../admin recharge/admin_recharge.php" style="margin-left: 40px;margin-top: 11px;width: 150.5px; position:relative;right:20px;  background: rgb(83,50,31);height: 56px;color: #dccab4;border-radius: 10px;border-color: #dccab4;">Recharge</a>
        </div>
        <div class="recharge" style="margin-bottom: 15px;"><a class="btn btn-primary" href="../admin recharge cus/admin_recharge_cus.php" style="margin-left: 180px;margin-top: 11px;position:relative;bottom:82.1px; width: 150.5px;background: rgb(83,50,31);height: 56px;color: #dccab4;border-radius: 10px;border-color: #dccab4;">Recharge Customer</a></div>
    </div>
    </div>
