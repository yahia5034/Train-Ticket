        ...
        <form action="editcusdb2.php" method="POST">
            <div class="row profile-row">
                ...
                <div class="col-md-8" style="background: #dccab4;">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group mb-3"><label class="form-label" style="color: rgb(83,50,31);">Username</label><input class="form-control" type="password" name="user_name" value="<?php echo $username; ?> " autocomplete="off" required="" style="border-color: rgb(83,50,31);background: linear-gradient(black, #c78e6b), rgb(129,80,51);"></div>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <div class="form-group mb-3"><label class="form-label" style="color: rgb(83,50,31);">Password</label><input class="form-control" type="password" name="cus_password" value="<?php echo $password; ?>" autocomplete="off" required="" style="border-color: rgb(83,50,31);background: linear-gradient(black, #c78e6b), rgb(129,80,51);"></div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="recharge" style="margin-bottom: 15px;"><a class="btn btn-primary" href="../cus recharge/cus_recharge.php"  style="margin-left: 695px;margin-top: 11px;width: 150.5px;background: rgb(83,50,31);height: 56px;color: #dccab4;border-radius: 10px;border-color: #dccab4;">Recharge Customer</a></div>
                    </div>
                    <div class="row">
                        <div class="col" style="margin-bottom: 15px;"><button class="btn btn-primary" type="submit" style="margin-left: 695px;margin-top: 11px;width: 150.5px;background: rgb(83,50,31);height: 56px;color: #dccab4;border-radius: 10px;border-color: #dccab4;">SAVE</button></div>
                    </div>
                </div>
            </div>
        </form>
